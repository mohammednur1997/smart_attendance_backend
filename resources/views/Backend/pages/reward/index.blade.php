...
@section("content")
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb pull-left">
            ...
            <li class="active">Reward Manage</li>
        </ol>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="panel panel-yellow">
                    <div class="panel-heading">Reward Employee</div>
                    <div class="panel-body pan">
                        <form action={{route("salary.reward.store")}} method="post" class="horizontal-form" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-success"><label
                                                ...
                                                <span class='require'>*</span></label>
                                            <input name="amount" type="text" placeholder="Enter amount of Reward" class="form-control" required/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group has-success"><label
                                                ...
                                                <span class='require'>*</span></label>
                                            <input type="text" id="datepicker" name="reward_date" data-date-format="yyyy-mm-dd"
            ...
            <div class="col-lg-6">
                <div class="panel panel-yellow">
                    <div class="panel-heading">Manage Reward</div>
                    <br>
                    <div class="panel-body pan">
                            ...
                            @foreach($reward as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a id="delete" href={{route("salary.reward.delete", $row->id)}} type="button" class="btn btn-danger btn-xs"><i
                                                class="fa fa-edit"></i>&nbsp;
                                            Delete
                                        </a>
                                    </td>
