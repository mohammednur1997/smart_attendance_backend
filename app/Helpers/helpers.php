...
if (!function_exists('translate')) {
    function translate($word){
        ...
        $wordcount = LanguageWord::where('word', $word)->count();
        $result = LanguageWord::where('word',$word)->first();
        if($wordcount>0){
            ...
            if($result->$set_lang !== NULL && $result->$set_lang !== ''){
                ...
                $return = LanguageWord::where('word',$word)->first()->english;
                $lang = 'english';
            }

        }else{
            $totalCount =  LanguageWord::count();
            $data = array();
            $data["id"] =  $totalCount;
            $data["word"] =  $word;
            $data["english"] =  ucwords(str_replace('_',' ',$word));
            LanguageWord::insert($data);
           /* DB::insert('insert into language_words (id,word,english) value(?,?)', [$totalCount, $word,ucwords(str_replace('_',' ',$word))]);*/
